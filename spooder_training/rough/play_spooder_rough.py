...
# Launch Omniverse App (GUI is active by default during play) logs/rsl_rl/spooder_flat/2026-07-10_19-09-49/
...
try:
    import spooder_env_cfg_rough
    print(f"[INFO] ✅ spooder_env_cfg_rough loaded from: {spooder_env_cfg_rough.__file__}")
except Exception as e:
    print(f"\n[FATAL] Failed to import spooder_env_cfg_rough:\n{traceback.format_exc()}")
    simulation_app.close()
    sys.exit(1)
...
try:
    gym.register(
        ...
        kwargs={
            "env_cfg_entry_point": getattr(spooder_env_cfg_rough, "SpooderFlatEnvCfg"),
            "rsl_rl_cfg_entry_point": getattr(spooder_env_cfg_rough, "SpooderFlatPPORunnerCfg"),
        },
    )
...
try:
    gym.register(
        ...
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": getattr(spooder_env_cfg_rough, "SpooderRoughEnvCfg"),
            "rsl_rl_cfg_entry_point": getattr(spooder_env_cfg_rough, "SpooderRoughPPORunnerCfg"),
        },
    )
...
def main():
    try:
        ...
        if "Flat" in args_cli.task:
            env_cfg = getattr(spooder_env_cfg_rough, "SpooderFlatEnvCfg")()
            agent_cfg = getattr(spooder_env_cfg_rough, "SpooderFlatPPORunnerCfg")()
            print("[INFO] ✅ Loaded flat terrain config")
        else:
            env_cfg = getattr(spooder_env_cfg_rough, "SpooderRoughEnvCfg")()
            agent_cfg = getattr(spooder_env_cfg_rough, "SpooderRoughPPORunnerCfg")()
