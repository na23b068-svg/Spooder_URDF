...
try:
    ...
    import spooder_env_cfg_1
    print(f"[INFO] ✅ spooder_env_cfg_1 loaded from: {spooder_env_cfg_1.__file__}")


except Exception as e:


    print(f"\n[FATAL] Failed to import spooder_env_cfg_1:\n{traceback.format_exc()}")
    simulation_app.close()
    sys.exit(1)
...
try:
    ...
    gym.register(
        ...
        kwargs={
            "env_cfg_entry_point": getattr(spooder_env_cfg_1, "SpooderFlatEnvCfg"),
            "rsl_rl_cfg_entry_point": getattr(spooder_env_cfg_1, "SpooderFlatPPORunnerCfg"),
        },
    )
...
try:
    ...
    gym.register(
        ...
        disable_env_checker=True,
        kwargs={
            "env_cfg_entry_point": getattr(spooder_env_cfg_1, "SpooderRoughEnvCfg"),
            "rsl_rl_cfg_entry_point": getattr(spooder_env_cfg_1, "SpooderRoughPPORunnerCfg"),
        },
    )
...
def main():
    try:
        ...
        if "Flat" in args_cli.task:
            env_cfg = getattr(spooder_env_cfg_1, "SpooderFlatEnvCfg")()
            agent_cfg = getattr(spooder_env_cfg_1, "SpooderFlatPPORunnerCfg")()
            print("[INFO] ✅ Loaded flat terrain config")
            
        else:
            env_cfg = getattr(spooder_env_cfg_1, "SpooderRoughEnvCfg")()
            agent_cfg = getattr(spooder_env_cfg_1, "SpooderRoughPPORunnerCfg")()
